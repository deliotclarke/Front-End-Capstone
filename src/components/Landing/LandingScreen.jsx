...
import { Container, Card, CardBody, UncontrolledCollapse, Lead, Button } from 'reactstrap'
...
export default class LandingScreen extends Component {
  ...
  render() {
    return (
      <>
        <Container>
          <h2 style={{ textAlign: "center", marginTop: "1rem" }}>Welcome, {this.props.user.username}!</h2>
          <br />
          <div>
            <p className="lead">This is <span style={{ color: "#3F7255", fontWeight: "700" }}>Resolute.</span> <br /><br />We're here to help you <br /><strong>get organized</strong>, <br /><strong>get to work,</strong> <br />and <strong>reach your goals</strong>.<br />We utilize a mini <span style={{ color: "#3F7255", fontWeight: "600" }}>Kanban Board</span> and the <span style={{ fontWeight: "600", color: "#BF4D43" }}>Pomodoro Technique</span> to help you get on track and stay there.<br /><br />If this is your first introduction to the <span style={{ fontWeight: "600", color: "#BF4D43" }}>Pomodoro Technique</span>, click the button below to see suggestion for utilizing our app.</p>
          </div>
          <Button id="toggler" style={{ marginBottom: '1rem', marginTop: '1rem' }}>
            How To
        </Button>
            ...
            <Card>
              <CardBody>
                ...
                <ul>
                  ...
                  <li>If you decide you'd like to remove a task entirely, just click the title of as many as you'd like deleted and press the <FaTimes /> button. Any task that has turned red and striked out will be removed permanently, so feel free to track what you've finished by leaving tasks in your Done board.</li>
                </ul>
